...
// transaction.
func (c *Client) GetRawTransaction(ctx context.Context, txHash *chainhash.Hash) (*ltcutil.Tx, error) {
...
func (c *Client) SearchRawTransactionsAsync(ctx context.Context, address ltcutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(ctx context.Context, address ltcutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(ctx context.Context, address ltcutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(ctx context.Context, address ltcutil.Address, skip,
