...
func (c *Client) GetRawTransactionAsync(ctx context.Context, txHash *wire.ShaHash) FutureGetRawTransactionResult {
	hash := ""
	if txHash != nil {
		hash = txHash.String()
	}
...
// transaction.
func (c *Client) GetRawTransaction(ctx context.Context, txHash *wire.ShaHash) (*godashutil.Tx, error) {
...
func (c *Client) GetRawTransactionVerboseAsync(ctx context.Context, txHash *wire.ShaHash) FutureGetRawTransactionVerboseResult {
	hash := ""
	if txHash != nil {
		hash = txHash.String()
	}
...
func (c *Client) GetRawTransactionVerbose(ctx context.Context, txHash *wire.ShaHash) (*btcjson.TxRawResult, error) {
...
func (c *Client) SendRawTransaction(ctx context.Context, tx *wire.MsgTx, allowHighFees bool) (*wire.ShaHash, error) {
...
func (c *Client) SearchRawTransactionsAsync(ctx context.Context, address godashutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(ctx context.Context, address godashutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(ctx context.Context, address godashutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(ctx context.Context, address godashutil.Address, skip,
