...
func DialHTTPWithClient(endpoint string, client *http.Client, user, password string) (*Client, error) {
...
func DialHTTP(endpoint, user, password string) (*Client, error) {
	return DialHTTPWithClient(endpoint, new(http.Client), user, password)
}
